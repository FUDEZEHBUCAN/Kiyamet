...
Shader "Toony Colors Pro 2/Examples/SG2/Wind Animation"
{
	Properties
	{
		...
		_Color ("Color", Color) = (1,1,1,1)
		 _Color1 ("Color Backfaces", Color) = (1,1,1,1)
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom vertex:vertex_surface exclude_path:deferred exclude_path:prepass keepalpha addshadow fullforwardshadows nolppv
		#pragma target 3.0
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			float4 __mainColor = (  lerp(_Color, _Color1, step(input.vFace,0.5)) );
