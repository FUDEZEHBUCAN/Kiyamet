...
Shader "MyTriplanarObject"
{
	...
	SubShader
	{
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			half2 uv_ground = input.objPos.xz;
			half2 uv_sideX = input.objPos.zy;
			half2 uv_sideZ = input.objPos.xy;
			float3 triplanarNormal = input.objNormal;
			...
			output.NormalCustom.xyz = UnityObjectToWorldNormal(output.NormalCustom);
