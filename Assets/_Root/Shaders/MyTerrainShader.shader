...
Shader "MyTerrainShader"
{
	...
	Dependency "AddPassShader"    = "Hidden/MyTerrainShader-AddPass"
	Dependency "BaseMapShader"    = "Hidden/MyTerrainShader-BasePass"
	Dependency "BaseMapGenShader" = "Hidden/MyTerrainShader-BaseGen"

	Fallback "Diffuse"
	CustomEditor "ToonyColorsPro.ShaderGenerator.MaterialInspector_SG2"
}

/* TCP_DATA u config(ver:"2.9.2";unity:"2022.3.62f3";tmplt:"SG2_Template_Default";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","TERRAIN_SHADER","TERRAIN_HEIGHT_BLENDING","ALBEDO_HSV","BUMP","DIFFUSE_TINT","TEXTURED_THRESHOLD","TT_SHADER_FEATURE","ENABLE_FOG","ENABLE_LIGHTMAPS","DITHERED_SHADOWS"];flags:list["addshadow","fullforwardshadows"];flags_extra:dict[pragma_gpu_instancing=list[]];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",BASEGEN_ALBEDO_DOWNSCALE="1",BASEGEN_MASKTEX_DOWNSCALE="1/2",BASEGEN_METALLIC_DOWNSCALE="1/4",BASEGEN_SPECULAR_DOWNSCALE="1/4",BASEGEN_DIFFUSEREMAPMIN_DOWNSCALE="1/4",BASEGEN_MASKMAPREMAPMIN_DOWNSCALE="1/4",RIM_LABEL="Rim Lighting"];shaderProperties:list[];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH e4def16f1276bf83fa33ff1a3bbd1563 */
